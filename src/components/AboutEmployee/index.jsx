...
const AboutEmployee = () => {
    ...
    return (
        <div className={`about-employee ${themeColor} ${themeMode}`}>
            <div className="section-wrapper no-border">
                <div className="row g-4 align-items-stretch">
                    <div className="col-lg-6 col-12">
                        <div className={`section-card h-100 d-flex flex-column border-0 ${themeColor}`}>
                    ...
                    <div className="col-lg-6 col-12">
                        <div className={`section-card h-100 d-flex flex-column wall-section border-0 ${themeColor}`}>
