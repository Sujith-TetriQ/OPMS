...
const TeamAttendance = ({ employees }) => {
  // Map employee status to categories
  const statusMap = {
    "Clocked In": "Present",
    "Clocked Out": "Absent",
    "On Break": "Leave",
  ...
  const data = useMemo(() => {
    ...
    employees.forEach((emp) => {
      const mapped = statusMap[emp.status];
  ...
  return (
    <div style={{ width: 500, height: 350, margin: "0 auto", position: "relative" }}>
      <PieChart width={500} height={350}>
        <Pie
          ...
          paddingAngle={2}
          dataKey="value"
          label={renderCustomLabel} // ✅ custom inside-slice labels
        >
